...
var Sleep, Steps, americano, async, dataFields, importData, importYear, localization, log, moment, querystring, request;
...
importData = function(start, csvData, callback) {
  var attr, columns, header, headers, i, j, len, lines, numItems, ref, saveLine;
  lines = csvData.split('\n');
  headers = lines[0];
  columns = {};
  j = 0;
