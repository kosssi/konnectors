module.exports =
    ...
    'konnector description ovh': "Download all your OVH Bills. This konnector requires the Files application to store the bill PDF files."
    ...
    'notification ovh': "%{smart_count} new invoice imported |||| %{smart_count} new invoices imported"
