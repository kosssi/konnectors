module.exports =
    ...
    'konnector description ovh': "Téléchargez toutes vos factures OVH. Pour pouvoir stocker les factures au format PDF, ce connecteur requiert que l'application Files soit installée sur votre Cozy."
    ...
    'notification ovh': "%{smart_count} nouvelle facture importée |||| %{smart_count} nouvelles factures importées"
